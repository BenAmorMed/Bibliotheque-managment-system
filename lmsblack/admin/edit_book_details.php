                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                    $bookid = $_GET['id'];
                                    $sql = "select * from LMS1.book where Bookid='$bookid'";
...
$sql1="update LMS1.book set Title='$name', Publisher='$publisher', Year='$year', Availability='$avail' where BookId='$bookid'";
