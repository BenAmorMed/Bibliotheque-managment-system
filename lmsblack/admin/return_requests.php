                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.BookId,return.username,Title,datediff(curdate(),Due_Date) as x from LMS1.return,LMS1.book,LMS1.record where return.BookId=book.BookId and return.BookId=record.BookId and return.username=record.username";
