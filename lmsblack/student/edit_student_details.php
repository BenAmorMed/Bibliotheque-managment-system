                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                $sql="select * from LMS1.user where username='$rollno'";
...
$sql1="update LMS1.user set Name='$name', Category='$category', EmailId='$email', MobNo='$mobno', Password='$pswd' where username='$rollno'";
